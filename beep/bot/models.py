...
class BotActionLogManager(ModelManager):
    ...
    ACTION_CHOICES = (
        ...
        (ACTION_BLOG_ADD_FOLLOWING, '发博文增加关注'),
    )
    ACTION_BLOG = [ACTION_BLOG_COMMNET, ACTION_BLOG_LIKE, ACTION_BLOG_FORWARD]
    ACTION_ACTIVITY = [ACTION_ACTIVITY_COMMENT]
    ACTION_USER = [ACTION_USER_FOLLOWING, ACTION_BLOG_ADD_FOLLOWING]
    ACTION_ALL = [ACTION_BLOG_COMMNET, ACTION_BLOG_LIKE, ACTION_BLOG_FORWARD, ACTION_ACTIVITY_COMMENT, ACTION_USER_FOLLOWING, ACTION_BLOG_ADD_FOLLOWING]
    ACTION_MAP = {
